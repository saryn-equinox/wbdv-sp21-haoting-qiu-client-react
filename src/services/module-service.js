class ModuleService {
    constructor() {
        this.urlWithCourseId = "https://wbdv-generic-server.herokuapp.com/api/001300329/courses"
    ...
    createModule(courseId, module) {
        return fetch(`${this.urlWithCourseId}/${courseId}/modules`, {
            method : "POST",
            headers : {
     ...
     */
    findModule(moduleId) {
        return fetch(`${this.urlWithModuleId}/${moduleId}`, {
            method : "GET"
        }).then(res => res.json());
    }
