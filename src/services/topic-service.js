class TopicService {
    constructor() {
        ...
        this.urlWithTopicId = " https://wbdv-generic-server.herokuapp.com/api/001300329/topics/"
    }
    ...
    createTopic(lessonId, topic) {
        return fetch(`${this.urlWithLessonId}/${lessonId}/topics`, {
            method : "POST",
            headers : {
     ...
     */
    findTopic(topicId) {
        return fetch(`${this.urlWithTopicId}/${topicId}`, {
            method : "GET"
        }).then(res => res.json());
    }
